...
const selectUserById = (username) => __awaiter(void 0, void 0, void 0, function* () {
    return connection_1.default.query('SELECT * FROM users WHERE username = $1', [username])
        .then(({ rows }) => {
        if (!rows.length)
...
const selectCommentsByUser = (username) => __awaiter(void 0, void 0, void 0, function* () {
    return connection_1.default.query('SELECT * FROM comments WHERE author = $1', [username])
        .then(({ rows }) => rows);
});
...
const checkUsernameExists = (username) => __awaiter(void 0, void 0, void 0, function* () {
    yield connection_1.default.query('SELECT * FROM users WHERE username = $1', [username])
        .then(({ rows }) => {
        if (!rows.length)
...
const insertUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    RETURNING *
    `;
    return connection_1.default.query(sql, [data.username, data.name, data.avatar_url])
        .then(({ rows }) => rows[0]);
});
exports.insertUser = insertUser;
const removeUser = (username) => __awaiter(void 0, void 0, void 0, function* () {
    yield connection_1.default.query('DELETE FROM users WHERE username = $1', [username]);
});
...
const selectArticlesByUser = (username) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
    return connection_1.default.query(sql, [username])
        .then(({ rows }) => rows);
});
